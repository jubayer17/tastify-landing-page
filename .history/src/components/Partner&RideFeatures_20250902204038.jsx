...
export default function PartnerAndRideFeatures() {
  return (
    <div className="my-10 grid justify-center">
      <div className="md:mb-0 mb-5  text-xl md:text-2xl font-semibold text-black text-center md:text-left">
        <h2 className="inline-block border-b-4 border-orange-500 pb-1">
          Partner & Rider Opportunities
        </h2>
      </div>
      <div className="md:mt-6 grid grid-cols-1 md:grid-cols-2 gap-10 justify-center md:mx-0 ">
        {/* First image section */}
