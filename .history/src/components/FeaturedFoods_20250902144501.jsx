      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-10">
        ...
        <div className="relative">
          ...
          <button
            ...
            onClick={() => scroll("left")}
            className="flex items-center justify-center absolute -ml-3 md:-left-5 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-sm border border-gray-200 text-gray-800 p-2 md:p-3 rounded-full shadow z-30 hover:bg-white transition"
          >
          ...
          >
            {featuredFoods.map((food) => (
              <article
                ...
                style={{
                  // width values tuned to show exactly 3 cards on small viewports (mobile)
                  // we use responsive inline widths so Tailwind's arbitrary calc doesn't need to be exact for every setup
              ...
              >
                ...
                <div className="relative w-full  sm:h-52 md:h-60">
                  <Image
                    src={food.image}
                    alt={food.name}
                    fill
